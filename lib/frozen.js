...
(function() {
  ...
  Model = (function() {
    function Model(attributes, options) {
      var coersion, error, opts, prop, type, validation, validator, value, _ref, _ref1;
      ...
      for (prop in _ref) {
        ...
        if (value instanceof coersion) {
          value = value.attributes;
        }
        this.attributes[prop] = new coersion(value, this.options);
      }
