...
(function() {
  ...
  Model = (function() {
    function Model(attributes, valid) {
    ...
    Model.prototype.set = function(attributes, valid) {
      if (valid == null) {
        valid = this.valid;
      }
      attributes = extend({}, this.attributes, attributes);
      return new this.constructor(attributes, valid);
    };

    Model.prototype.validate = function(valid) {
      if (valid == null) {
        valid = 'force';
      }
      return new this.constructor(this.attributes, valid);
    };
  ...
  Collection = (function() {
    ...
    Collection.prototype.insert = function(index, model) {
      var models;
      if (model == null) {
        model = {};
      }
      ...
      models = this.models.slice(0, index);
      models.push(model);
      models = models.concat(this.models.slice(index));
    ...
    Collection.prototype.push = function(model) {
      ...
      return this.insert(this.length, model);
    };

    Collection.prototype.change = function(index, attributes) {
      var idx, model, models;
      models = (function() {
